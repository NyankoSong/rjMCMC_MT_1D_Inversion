function [lh, SE] = likelihood_func(Cd, rhoa_obs_log, phs_obs, f_rhoa, f_phs, rho_log, z_log, k_weight, data_scale_factor)
...
SE = norm((Cd^(-1/2))*([rhoa_log.*(2-k_weight); phs.*k_weight]-[rhoa_obs_log.*(2-k_weight); phs_obs.*k_weight]))^2 ./ length(Cd);
